...
public enum ErrorCode {
    ...
    INSUFFICIENT_BALANCE(CONFLICT.value(), "잔액이 부족합니다."),
    EXCEED_MAXIMUM_ORDER_PRODUCT(CONFLICT.value(), "한 번에 주문할 수 있는 최대 주문 상품 개수를 초과하였습니다."),
    EXPIRED_COUPON(CONFLICT.value(), "이미 만료일이 지난 쿠폰입니다."),
    ;
