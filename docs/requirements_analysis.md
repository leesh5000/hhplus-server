...
- [1. 잔액 충전](#1-잔액-충전)
  - [1.1. 요구사항 분석](#11-요구사항-분석)
  - [1.2. 시퀀스 다이어그램](#12-시퀀스-다이어그램)
  - [1.3. API](#13-api)
- [2. 잔액 조회](#2-잔액-조회)
  - [2.1. 요구사항 분석](#21-요구사항-분석)
  - [2.2. 시퀀스 다이어그램](#22-시퀀스-다이어그램)
  - [2.3. API](#23-api)
- [3. 상품 조회](#3-상품-조회)
  - [3.1. 요구사항 분석](#31-요구사항-분석)
  - [3.2. 시퀀스 다이어그램](#32-시퀀스-다이어그램)
  - [3.3. API](#33-api)
- [4. 유저가 보유한 쿠폰 조회](#4-유저가-보유한-쿠폰-조회)
  - [4.1. 요구사항 분석](#41-요구사항-분석)
  - [4.2. 시퀀스 다이어그램](#42-시퀀스-다이어그램)
  - [4.3. API](#43-api)
- [5. 선착순 할인 쿠폰 발급](#5-선착순-할인-쿠폰-발급)
  - [5.1. 요구사항 분석](#51-요구사항-분석)
  - [5.2. 시퀀스 다이어그램](#52-시퀀스-다이어그램)
  - [5.3. API](#53-api)
- [6. 상품 주문/결제](#6-상품-주문결제)
  - [6.1. 요구사항 분석](#61-요구사항-분석)
  - [6.2. 시퀀스 다이어그램](#62-시퀀스-다이어그램)
  - [6.3. API](#63-api)
- [7. 상위 상품 조회](#7-상위-상품-조회)
  - [7.1. 요구사항 분석](#71-요구사항-분석)
  - [7.2. 시퀀스 다이어그램](#72-시퀀스-다이어그램)
  - [7.3. API](#73-api)
...
```http request
GET /api/v1/products/top-sold?startDate=2021-08-01&endDate=2021-08-31&page=0&size=10
```
